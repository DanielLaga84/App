        ...
        return (
            <Switch>
                ...
                <SecureRoute
                    ...
                    exact={true}
                    render={(props) => <CoffeeShopsEdit {...props} authenticated={authenticated} user={user} api={api}
                                                        navbar={navbar}
                    />}
                />
            </Switch>
    ...
    render() {
        return (
            <Router>
                ...
                <Security issuer='https://dev-81228146.okta.com/oauth2/default'
                          clientId='0oanbyl15e31qeZH25d6'
